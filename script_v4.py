...
from google.colab import files  # If running in Google Colab
...
def get_tsx_tickers():
    tsx_tickers = [
        ...
        "ENB.TO", "SU.TO", "TRP.TO", "CNR.TO", "CNQ.TO",
        "GIL.TO", "BCE.TO", "FTS.TO", "MFC.TO", "BAM.A.TO"
    ]
    return tsx_tickers

# Updated fetch_stock_data function to use the new order
