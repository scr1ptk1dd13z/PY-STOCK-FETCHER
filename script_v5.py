...
# Updated fetch_stock_data function remains unchanged
def fetch_stock_data(tickers):
    ...
    with ThreadPoolExecutor(max_workers=10) as executor:
        ...
        stock_data = [executor.submit(fetch_ticker_data, ticker, index, total_tickers) for index, ticker in enumerate(tickers, start=1)]
